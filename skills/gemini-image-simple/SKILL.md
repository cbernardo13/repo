...
Generate and edit images using Google's **Gemini 3 Pro Image** - the highest quality image generation model.

## Why This Skill

| Feature | This Skill | Others (gemini-3-pro, etc.) |
|---------|------------|-------------------------------|
...
Uses **Gemini 3 Pro Image** (`gemini-3-pro-image-preview`) - Google's highest quality image generation model:
...
Currently using: `gemini-3-pro-image-preview`
